			...
			if(strlen($upload_image) >= 1 && strlen($content) >= 1){
				...
				if($upload_image=='' && $content == ''){
					...
					if($content==''){
						...
						if($run){
							echo "<script>alert('Your Post is successfully updated!')</script>";
							echo "<script>window.open('home.php', '_self')</script>";
 	...
 	if(isset($_GET['post_id'])){
		...
		if(isset($_POST['reply'])){
			...
			if($comment == ""){
				...
				echo "<script>window.open('single.php?post_id=$post-id', '_self')</script>";
			}
			else{
       ...
       else
       {
			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6' >
					...
					<a href='single.php?post_id=$post_id' style='float:right;'><button style='color:#00cc00;'>View</button></a>
                    <a href='functions/delete_post.php?post_id=$post_id' style='float:right;'><button style='color:red;'>Delete</button></a>
				</div>
				<div class='col-sm-3'>
				</div>
			</div><br><br>
			...
			<div class='row'>
				...
				<div id='posts' class='col-sm-6'>
					...
					<a href='single.php?post_id=$post_id' style='float:right;'><button style='color:#00cc00;'>View</button></a>
                    <a href='edit_post.php?post_id=$post_id' style='float:right;'><button style='color:#0000ff;'>Edit</button></a>
                    <a href='functions/delete_post.php?post_id=$post_id' style='float:right;'><button style='color:red;'>Delete</button></a>
				</div>
				<div class='col-sm-3'>
				</div>
           ...
           <div class='row'>
              ...
              <div class='col-sm-6'>
                  <div class='row' id='find_people'>
                     ...
                     <div class='col-sm-6'>
                        <a style='text-decoration:none; cursor:pointer;' href='user_profile.php?u_id=$user_id'>
