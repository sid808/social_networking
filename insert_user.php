...
include("includes/connection.php");
	...
	if(isset($_POST['sign_up'])){
		...
		if (strlen($pass)<9 ) {
			echo "<script>alert('Password should be minimum 9 charecters!')</script>";
			exit();
		}
		...
		values('$first_name','$last_name','$username','Hello Chatbook.This is my default status!','...','$pass','$email','$country','$gender','$birthday','$profile_pic','default_cover.jpeg',NOW(),'$status','$posts','Iwanttodoit.')";
