...
<div class="row">
	...
	<div class="col-sm-8">
		<?php
			...
			<div id='profile-img'>
				...
				<label id='update_profile'>Profile Image
				<input type='file' name='u_image' size='60' />
				</label><br><br>
				<button id='button_profile' name='update' class='btn btn-info'>Update Profile/Image</button>
				</form>
			</div><br>
			";
		?>
	...
	<?php
		if(isset($_POST['update'])){
				...
				if($u_image==''){
					echo "<script>alert('Please select your profile picture by clicking on Profile Image')</script>";
					echo "<script>window.open('profile.php?u_id=$user_id' , '_self')</script>";
					exit();
				}else{
